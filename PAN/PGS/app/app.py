...
app.layout = html.Div([
    ...
    dbc.Row([
        dbc.Col(
            html.Div([
                dbc.Col(html.Div(["", "1-CPT (R² 0.90)", html.Img(src=app.get_asset_url('HLT_50Q_10T_CPT-krs-MLR.png'), style={'width':'90%'})])),
                dbc.Col(html.Div(["", "POE (R² 0.92)", html.Img(src=app.get_asset_url('HLT_50Q_10T_POE-krs-MLR.png'), style={'width':'90%'})])),
                dbc.Col(html.Div(["","WOP (R² 0.89)", html.Img(src=app.get_asset_url('HLT_10T_WOP-krs-MLR.png'), style={'width':'90%'})])),
            ], style={'paddingLeft': '5%'})
        )
    ])
], style={'width': "99.2%"})
